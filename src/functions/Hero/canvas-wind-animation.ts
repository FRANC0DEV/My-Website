...
//   {
//     x: 50, // X position on canvas (horizontal placement)
//     y: 80, // Y position on canvas (vertical placement)
//     startTime: 0, // When to start (in seconds from page load)
//     duration: 3, // Duration of one complete cycle in seconds (draw + erase)
//     loopInterval: 10, // Time before the wind starts again (total cycle time)
//     scale: 0.5, // Scale factor (1 = normal size, 0.5 = half size, etc)
//     strokeWidth: 3, // Stroke width (base thickness)
//     strokeColor: "#c5c5c5", // Stroke color (hex or rgb)
//   },
//   {
//     x: 150,
//     y: 200,
//     startTime: 4, // Start 4 seconds after page load
//     duration: 3,
//     loopInterval: 10,
//     scale: 0.5,
//     strokeWidth: 3,
...
//     x: 600,
//     y: 400,
//     startTime: 6, // Start 6 seconds after page load
//     duration: 2.5,
//     loopInterval: 2.8,
//     scale: 0.5,
//     strokeWidth: 2.5,
...
//     x: 500,
//     y: 450,
//     startTime: 9, // Start 7 seconds after page load
//     duration: 3.5,
//     loopInterval: 4,
//     scale: 0.5,
//     strokeWidth: 3.5,
...
//     x: 650,
//     y: 250,
//     startTime: 12, // Start 10 seconds after page load
//     duration: 2,
//     loopInterval: 3.2,
//     scale: 0.5,
//     strokeWidth: 2,
...
//     x: 100,
//     y: 500,
//     startTime: 2, // Start 6 seconds after page load
//     duration: 1.7,
//     loopInterval: 2.8,
//     scale: 0.5,
//     strokeWidth: 2.5,
...
//     x: 100,
//     y: 350,
//     startTime: 1.5, // Start 6 seconds after page load
//     duration: 1.5,
//     loopInterval: 2.8,
//     scale: 0.5,
//     strokeWidth: 2.5,
...
//     x: 750,
//     y: 150,
//     startTime: 4, // Start 6 seconds after page load
//     duration: 4,
//     loopInterval: 5,
//     scale: 0.5,
//     strokeWidth: 2.5,
...
//     x: 700,
//     y: 50,
//     startTime: 1.8, // Start 6 seconds after page load
//     duration: 3,
//     loopInterval: 4,
//     scale: 0.5,
//     strokeWidth: 2.5,
...
// function drawWind(windInfo: WindData, progress: number) {
//   const totalCycleDuration = windInfo.loopInterval; // Total loop time
//   const cycleProgress = progress / totalCycleDuration;

//   // Only draw if we're within the duration (not in the wait time)
//   if (cycleProgress > windInfo.duration / windInfo.loopInterval) {
//     return; // Wind is not animating yet in this cycle
//   }

//   const pathPoints = windInfo.pathPoints;
//   const lineWidth = (windInfo.strokeWidth || 3) * windInfo.scale;
//   const eraserWidth = (windInfo.strokeWidth || 3) * windInfo.scale * 6.67; // Proportional to stroke width
//   const strokeColor = windInfo.strokeColor || "#bbbbbb"; // Use custom color or default

//   // Normalize progress to 0-1 for the actual animation duration
//   const animProgress =
...
//     // Draw wind path with gradient effect - multiple strokes for depth
//     for (let offset = 0; offset >= 1; offset--) {
//       // Create a lighter version of the stroke color for the background layers
//       ctx!.strokeStyle = `rgba(100, 100, 100, ${0.15 * (1 - offset / 8)})`;
//       ctx!.lineWidth = lineWidth + offset;
//       ctx!.lineCap = "round";
//       ctx!.lineJoin = "round";
//       ctx!.beginPath();
...
//     // Draw remaining wind path
//     for (let offset = 0; offset >= 1; offset--) {
//       ctx!.strokeStyle = `rgba(200, 200, 200, ${0.15 * (1 - offset / 8)})`;
//       ctx!.lineWidth = lineWidth + offset;
//       ctx!.lineCap = "round";
//       ctx!.lineJoin = "round";
//       ctx!.beginPath();
...
//     // Check if this wind should be active
//     if (elapsed >= windInfo.startTime) {
//       // Calculate time since this wind started
//       const windElapsed = elapsed - windInfo.startTime;
//       // Loop the animation based on loopInterval
//       const windProgress = windElapsed % windInfo.loopInterval;
//       drawWind(windInfo, windProgress);
//     }
//   });
...
function getBackgroundColor(theme: BrowserTheme): string {
  return theme === "dark" ? "#1a1a1a" : "white";
}
